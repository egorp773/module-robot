...
SendCmd "PING"
$lat=$null;$lon=$null;$dl=(Get-Date).AddSeconds(3)
...
SendWait "ROUTE_END" "OK,ROUTE" 2500 | Out-Null
Start-Sleep -Milliseconds 300
SendWait "DIAG" "sol=" 2000 | Out-Null
Write-Host "[*] uploaded. NAV_START NOT sent. robot stays put."
